...
class ConfigurableCardReader : virtual public CardReader {
 public:
  ...
  /**
   * Activates the reader communication protocol by associating the provided
   * reader communication protocol name and the communication protocol name
   * defined by the application.
   *
   * <ul>
   *   <li>Activates the detection of cards using the provided reader
   * communication protocol. <li>Internally associates the two strings provided
   * as arguments.
   * </ul>
   *
   * <p>The association between the communication protocol name known by the
   ...
   * set when constructing a card selector as defined by the <b>Terminal Card
   * API</b> regardless of the type of reader that will be used.
   *
   * @param readerProtocol The name of the communication protocol as known by
   * the reader. See the reader documentation for the list of supported
   * communication protocols.
   * @param cardProtocol The name of the communication protocol of the card
   * which be detect as defined by the application.
